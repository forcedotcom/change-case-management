...
/*shell.exec(`sfdx force:data:record:update -s Case -i 500B0000004lmHRIAY -v "Origin=Phone" -u rn@su-blitz.org`)
var data = shell.exec(`sfdx force:data:soql:query -q "SELECT Origin FROM Case where Id='500B0000004lmHRIAY'" -u rn@su-blitz.org`);
console.log(data);*/