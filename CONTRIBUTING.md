...
1. Once merged, a new release of the `salesforcecli/change-case-management` plugin will be published to [npm](https://www.npmjs.com/package/@salesforce/change-case-management).
...
- A new version of this plugin (`@salesforce/change-case-management`) will be published upon merging PRs to `main`, with the version number increment based on commitizen rules.
